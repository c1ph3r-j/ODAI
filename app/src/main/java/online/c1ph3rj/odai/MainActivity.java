...
import online.c1ph3rj.odai.databinding.ActivityMainBinding;
...
//        final String baseUrl = "https://huggingface.co/llmware/llama-3.2-1b-instruct-onnx/resolve/main/";
...
//                "tokenizer_config.json");
        ...
        final String baseUrl = "https://huggingface.co/onnx-community/Llama-3.2-1B-Instruct-ONNX/resolve/main/cpu_and_mobile/cpu-int4-rtn-block-32-acc-level-4/";
        List<String> files = Arrays.asList(
                "config.json",
                "genai_config.json",
                "model.onnx",
